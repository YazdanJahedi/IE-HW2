module.exports = (app) => {
  ...
  route.get(
    "/admin/professor/:id",
    controllers.admin_find_users_by_id(roles[1])
  );
  ...
  route.post(
    "/course",
    [authJwt.verifyToken, authJwt.verify_edu_manager],
    controllers.eduManager_create_course
  );
  route.put(
    "/course/:id",
    [authJwt.verifyToken, authJwt.verify_edu_manager],
    controllers.eduManager_update_course
  );
  route.delete(
    "/course/:id",
    [authJwt.verifyToken, authJwt.verify_edu_manager],
    controllers.eduManager_delete_course
  );
  ...
  route.get(
    "/students",
    [authJwt.verifyToken, authJwt.verify_edu_manager],
    controllers.eduManager_find_all_users(roles[0])
  );
  route.get(
    "/student/:id",
    [authJwt.verifyToken, authJwt.verify_edu_manager],
    controllers.eduManager_find_users_by_id(roles[0])
  );
  route.get(
    "/professors",
    [authJwt.verifyToken, authJwt.verify_edu_manager],
    controllers.eduManager_find_all_users(roles[1])
  );
  route.get(
    "/professor/:id",
    [authJwt.verifyToken, authJwt.verify_edu_manager],
    controllers.eduManager_find_users_by_id(roles[1])
  );

  // Student update student
  route.put(
    "/student/:id",
    [authJwt.verifyToken, authJwt.verify_student],
    controllers.student_update_student
  );

  // Teacher update Teacher
  route.put(
    "/professor/:id",
    [authJwt.verifyToken, authJwt.verify_teacher],
    controllers.teacher_update_teacher
  );
  ...
  route.get(
    "/course/:id",
    [authJwt.verifyToken],
    controllers.find_courses_by_id
  );
