module.exports = (mongoose) => {
  ...
  const Students_model = Users_model.discriminator(
    "Students",
    new mongoose.Schema({
      grade: String,
      entry_year: Number,
  ...
  const Teachers_model = Users_model.discriminator(
    "Teachers",
    new mongoose.Schema({
      faculty: String,
      field: String,
  ...
  const Edu_man_model = Users_model.discriminator(
    "Edu_manager",
    new mongoose.Schema({
      faculty: String,
    })
  ...
  const Termic_model = Lessons_model.discriminator(
    "Termic_lessons",
    new mongoose.Schema({
      class_date: Date,
      class_time: String,
  ...
  const IT_man_model = Users_model.discriminator(
    "IT_mangager",
    mongoose.Schema({})
  );
